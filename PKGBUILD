...
package() {
	...
	# Install Share files
	mkdir -p "$pkgdir/usr/share/icons/hicolor/72x72/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/72x72/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/72x72/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/256x256/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/256x256/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/256x256/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/128x128/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/128x128/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/128x128/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/16x16/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/16x16/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/16x16/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/24x24/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/24x24/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/24x24/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/64x64/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/64x64/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/64x64/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/32x32/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/32x32/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/32x32/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/96x96/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/96x96/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/96x96/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/36x36/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/36x36/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/36x36/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/48x48/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/48x48/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/48x48/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/icons/hicolor/22x22/apps/"
	install -m644 "$srcdir/usr/share/icons/hicolor/22x22/apps/bitcasa.png" "$pkgdir/usr/share/icons/hicolor/22x22/apps/bitcasa.png"
	mkdir -p "$pkgdir/usr/share/applications/"
	install -m644 "$srcdir/usr/share/applications/bitcasa.desktop" "$pkgdir/usr/share/applications/bitcasa.desktop"
	mkdir -p "$pkgdir/usr/share/menu/"
	install -m644 "$srcdir/usr/share/menu/bitcasa" "$pkgdir/usr/share/menu/bitcasa"
	mkdir -p "$pkgdir/usr/share/doc/bitcasa/"
	install -m644 "$srcdir/usr/share/doc/bitcasa/changelog.gz" "$pkgdir/usr/share/doc/bitcasa/changelog.gz"
	mkdir -p "$pkgdir/usr/share/pixmaps/"
	install -m644 "$srcdir/usr/share/pixmaps/bitcasa.xpm" "$pkgdir/usr/share/pixmaps/bitcasa.xpm"
